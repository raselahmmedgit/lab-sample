...
namespace ContactProfile.App.Extensions
{
    ...
    public static class TypeExtensions
    {
        ...
        public static DateTime ToDefaultDesignatedTimeZoneDstFromUtc(this DateTime utcDateTime)
        {
            var curTz = TimeZone.CurrentTimeZone;
            bool isDaylightSavingTime = curTz.IsDaylightSavingTime(utcDateTime);
