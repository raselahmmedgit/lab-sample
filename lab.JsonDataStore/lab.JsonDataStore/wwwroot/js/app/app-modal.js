...
var AppModal = function () {
    ...
    var commonModalComplete = function () {
        App.LoaderHide();
    }

    var commonModalCompleteForDataTable = function (dataTableId) {
    ...
    var commonModalFormValidation = function (fromId) {
        ...
        if ($form.length > 1) {
            console.log("Web form cannot be identified.");
        } else {
    ...
    return {
        ...
        CommonModalCompleteForDataTable: commonModalCompleteForDataTable,
