...
namespace RnD.BlazorApp.WebApi.Core
{
    public class EmailTemplateHelper
    {
        ...
        public static string GetContactSendMessageEmailTemplate(string title = "Contact Us!", ContactSendMessageViewModel contactSendMessageViewModel = null)
        {
            string html = string.Empty;
            ...
            if (contactSendMessageViewModel != null)
            {
                ...
                html += "<h2 style='line-height: 36px; font-size: 24px;'>";
                html += $"Subject : {contactSendMessageViewModel.ContactSubject}";
                html += "</h2>";
                html += "<h5 style='line-height: 30px; font-size: 21px; margin-bottom: 5px;'>";
